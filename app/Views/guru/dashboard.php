        ...
        <div class="card-body p-4 p-md-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-center d-none d-lg-block">
                    <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto text-success"
                ...
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <span class="text-secondary small fw-medium" style="text-transform: none !important;">SANTRI
                            BINAAN WALI KELAS</span>
                        <h3 class="fw-bold text-dark-mode mb-0 mt-1"><?= esc($total_santri_binaan ?? 0); ?> <span
                                class="fs-6 fw-normal text-secondary small">Santri</span></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <span class="text-secondary small fw-medium" style="text-transform: none !important;">SETORAN
                            HARI INI</span>
                        <h3 class="fw-bold text-dark-mode mb-0 mt-1"><?= esc($total_setoran_hari_ini ?? 0); ?> <span
                                class="fs-6 fw-normal text-secondary small">Santri</span></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <span
                            class="badge bg-success bg-opacity-10 text-success px-3 py-1 rounded-pill fw-semibold small">
                            <?= date('d M Y'); ?>
                        </span>
                    </div>
                    ...
                    <?php if (!empty($kelas_binaan)): ?>
                        <div class="d-flex flex-column gap-3">
                            ...
                            <!-- Detail Kelas Utama -->
                            <div
                                class="p-4 rounded-4 border border-success border-opacity-25 bg-success bg-opacity-10 position-relative overflow-hidden">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2 ps-2">
                                    ...
                                    <span
                                        class="badge bg-white text-success border border-success border-opacity-25 px-2 py-1 small fw-bold">
                                        <span class="spinner-grow spinner-grow-sm text-success me-1" role="status"
                                            style="width: 8px; height: 8px;"></span> <?= esc($guru['status_aktif']) ?>
                                    </span>
                                </div>

                                <div class="ps-2 mt-3">
                                    <h4 class="fw-bold text-dark-mode mb-1">Kelas <?= esc($kelas_binaan['nama_kelas']); ?>
                                    </h4>
                                    <p class="text-secondary small mb-0">
                                        <i class="fa-solid fa-user-tie text-success me-1"></i> Pengampu:
                                        <?= esc($guru['nama_guru'] ?? session()->get('name')); ?>
                                    </p>
                                </div>
                            </div>

                            <!-- Kotak Panduan Singkat -->
                            <div class="card p-3 rounded-4 bg-light border">
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary small mb-0" style="font-size: 0.75rem;">
                                            Pastikan untuk selalu memeriksa dan memvalidasi setoran hafalan santri secara
                                            berkala pada panel sebelah kanan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <small class="text-secondary" style="font-size: 0.7rem;">
                                                    ...
                                                    <?= date('H:i', strtotime($h['created_at'])); ?> WIB
                                                </small>
                                            </td>
                                            <td class="ps-3">
                                                <div class="fw-semibold text-dark-mode small"><?= esc($h['nama_santri']); ?>
                                                </div>
                                                <small class="text-secondary"
                                                    style="font-size: 0.75rem;"><?= esc($h['nama_kelas']); ?></small>
                                            </td>
                                            <td>
                                                <span class="small text-dark-mode d-block">Surah <?= esc($h['surah']); ?></span>
                                                <small class="text-secondary" style="font-size: 0.75rem;">Ayat
                                                    <?= esc($h['ayat_mulai']); ?>-<?= esc($h['ayat_selesai']); ?></small>
                                            </td>
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-<?= $badgeColor; ?> bg-opacity-10 text-<?= $badgeColor; ?> px-2 py-1 rounded-pill"
