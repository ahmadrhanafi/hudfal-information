...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1 text-dark-mode" style="text-transform: none !important;">Riwayat Hafalan
                Santri Kelas <?= esc($nama_kelas); ?></h3>
            <p class="text-muted mb-0 small text-dark-mode" style="text-transform: none !important;">Pantau rekam jejak
                ...
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <span class="text-secondary small fw-medium" style="text-transform: none !important;">TOTAL
                            SETORAN BULAN INI</span>
                        <h3 class="fw-bold text-dark-mode mb-0 mt-1">
                            <?= $total_setoran_bulan_ini ?? 0; ?> <span
                                class="fs-6 fw-normal text-secondary">Hafalan</span>
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <span class="text-secondary small fw-medium" style="text-transform: none !important;">SANTRI
                            AKTIF SETORAN</span>
                        <h3 class="fw-bold text-dark-mode mb-0 mt-1">
                            <?= $santri_aktif ?? 0; ?> / <?= $total_santri ?? 0; ?> <span
                                class="fs-6 fw-normal text-secondary">Santri</span>
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="searchInput" class="form-control bg-light border-0 py-2"
                            placeholder="Cari nama atau nomor induk santri...">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php if (!empty($santri) && is_array($santri)): ?>
                            ...
                            foreach ($santri as $s):
                                ...
                                ?>
                                <tr class="item-row"
                                    data-search="<?= strtolower(esc($s['nama_santri'] . ' ' . $s['nis'] . ' ' . ($s['nama_kelas'] ?? ''))); ?>">
