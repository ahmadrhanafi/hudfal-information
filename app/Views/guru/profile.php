            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white text-center p-4">
                <div class="card-body">
                    <div class="position-relative d-inline-block mb-3">
                        <?php
                        $namaFile = $user['foto'] ?? '';
                        $pathRelatif = 'uploads/profile/' . $namaFile;
                        $adaFoto = !empty($namaFile) && file_exists(FCPATH . $pathRelatif);
                        ?>

                        <?php if ($adaFoto): ?>
                            <img src="<?= base_url($pathRelatif); ?>" class="rounded-circle shadow-sm object-fit-cover"
                                style="width: 100px; height: 100px;" alt="Foto Profil">
                        <?php else: ?>
        ...
        <div class="col-xl-8">
            <div class="card border-0 shadow-sm rounded-4 bg-white">
                <div class="card-body p-4">
                    ...
                    <p class="text-secondary small mb-4">Perbarui informasi data akademik, akun login, dan keamanan kata
                        sandi
                        Anda.</p>
                    ...
                    <form action="<?= base_url('guru/profile/update') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <?php if ($guru): ?>
                            ...
                            <h6 class="fw-bold text-dark-mode mb-3" style="text-transform: none !important;">Data
                                Kepegawaian
                                Guru
                            </h6>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold text-dark-mode">NIP</label>
                                    <input type="text"
                                        class="form-control form-control-sm bg-secondary bg-opacity-25 text-dark-mode border-0 py-2 <?= session('errors.nip') ? 'is-invalid' : '' ?>"
                                        name="nip" value="<?= old('nip', $guru['nip']) ?>" readonly disabled>
                                    <div class="invalid-feedback">
                                        <?= session('errors.nip') ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold text-dark-mode">Nama Lengkap & Gelar</label>
                                    <input type="text"
                                        class="form-control form-control-sm bg-light border-0 py-2 <?= session('errors.nama_guru') ? 'is-invalid' : '' ?>"
                                        name="nama_guru" value="<?= old('nama_guru', $guru['nama_guru']) ?>" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold text-dark-mode">Jenis Kelamin</label>
                                    <select name="jenis_kelamin" class="form-select form-select-sm bg-light border-0 py-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        name="no_hp" value="<?= old('no_hp', $guru['no_hp']) ?>" required>
                                    <div class="invalid-feedback">
