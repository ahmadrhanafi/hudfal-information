...
<div class="container-fluid px-4 py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        ...
        <div>
            <a href="<?= base_url('wali/dashboard'); ?>" class="btn btn-outline-secondary btn-sm px-3 rounded-pill bg-white shadow-sm">
        ...
        <div class="col-xl-8">
            <div class="card border-0 shadow-sm rounded-4 bg-white mb-4">
                ...
                <div class="card-footer bg-success py-3 px-4 border-0 text-end rounded-bottom-4">
                    <a href="<?= base_url('wali/dashboard'); ?>" class="btn btn-secondary btn-sm bg-secondary bg-opacity-30 px-4 py-2 rounded-3 shadow-sm">Selesai</a>
                </div>
            </div>
        </div>
