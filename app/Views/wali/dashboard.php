    ...
    <div class="card border-0 shadow-sm rounded-4 bg-white mb-4 position-relative overflow-hidden">
        <div class="card-body p-4 p-md-5">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-8">
                    <span
                        class="badge bg-success bg-opacity-10 text-success px-3 py-1 rounded-pill mb-2 fw-semibold small">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3 pt-1">
                        <div class="d-inline-flex align-items-center gap-2 bg-light px-3 py-2 rounded-pill border">
                            ...
                            <span class="text-dark fw-semibold small"><?= esc((string) $stat_jumlah_anak); ?> Santri
                                Aktif Terhubung</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 text-center d-none d-lg-block">
                    <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center mx-auto text-success shadow-sm"
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="fw-bold text-dark-mode mb-0" style="margin-left: 20px !important;"><i
                        class="fa-solid fa-layer-group text-success me-2"></i> Rekapitulasi Hafalan Ananda</h5>
            </div>
        </div>
                        ...
                        <div class="card-body p-4">
                            <div class="row align-items-center g-4">
                                        ...
                                        <div>
                                            <div class="mb-1">
                                                <a href="<?= base_url('wali/santri-detail/' . $a['id']); ?>"
                                                    title="Lihat Profil"
                                                    class="fw-bold text-dark-mode text-decoration-none custom-dashed-link fs-5">
                                                    <?= esc($a['nama_santri']); ?>
                                                </a>
                                            </div>
                                            <div class="d-flex flex-wrap gap-2 align-items-center mt-1">
                                                ...
                                                <span
                                                    class="badge bg-success bg-opacity-10 text-success border px-2.5 py-1 rounded-pill"
                                                    style="font-size: 10px;">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="p-2.5 px-3 rounded-3 border-0 h-100 d-flex align-items-center gap-2">
                                                <div class="text-success bg-success bg-opacity-10 p-2 rounded-2 d-flex align-items-center justify-content-center"
                                                    style="width: 35px; height: 35px;">
                                                    <i class="fa-solid fa-award"></i>
                                                </div>
                                                <div class="overflow-hidden">
                                                    <span class="text-secondary d-block fw-semibold text-uppercase"
                                                        style="font-size: 0.6rem;">Capaian Terakhir</span>
                                                    <span class="fw-bold text-dark-mode text-truncate d-block"
                                                        style="font-size: 0.7rem;"><?= esc($a['stat_juz'] ?? 'Belum ada data'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="p-2.5 px-3 rounded-3 border-0 h-100 d-flex align-items-center gap-2">
                                                <div class="text-primary bg-primary bg-opacity-10 p-2 rounded-2 d-flex align-items-center justify-content-center"
                                                    style="width: 35px; height: 35px;">
                                                    <i class="fa-solid fa-clipboard-check"></i>
                                                </div>
                                                <div class="overflow-hidden">
                                                    <span class="text-secondary d-block fw-semibold text-uppercase"
                                                        style="font-size: 0.6rem;">Total Setoran</span>
                                                    <span class="fw-bold text-dark-mode d-block"
                                                        style="font-size: 0.7rem;"><?= esc($a['stat_total_setoran'] ?? 0); ?>
                                                        <span class="fw-normal text-secondary"
                                                            style="font-size: 0.75rem;">Kali</span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 text-lg-end">
                                    <a href="<?= base_url('wali/riwayat-hafalan?id_santri=' . $a['id']); ?>"
                                        class="btn btn-success btn-sm px-4 py-2 rounded-3 fw-semibold shadow-sm w-100 d-inline-flex align-items-center justify-content-center gap-2">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4 bg-white text-center p-5">
                    <div class="card-body">
                        ...
                        <p class="text-secondary small mb-0">Belum ada data santri/anak yang dihubungkan dengan akun wali
                            ini. Silakan hubungi admin pesantren.</p>
                    </div>
                </div>
            </div>
        <?php endif; ?>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="<?= base_url('wali/riwayat-hafalan') ?>"
                            class="text-success small fw-semibold text-decoration-none" style="font-size: 0.7rem;">
                            Riwayat Lengkap <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                    <p class="text-secondary small mb-3" style="text-transform: none !important; font-size: 0.8rem;">
                        Catatan setoran terakhir yang diuji oleh ustadz pengampu di pesantren.</p>
                                    ...
                                    <?php foreach ($setoran_terbaru as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge bg-success bg-opacity-10 text-success px-2 py-0 rounded-pill"
                                            ...
                                            <td>
                                                <span
                                                    class="small text-dark-mode d-block fw-semibold"><?= esc($row['surah'] ?? $row['capaian'] ?? '-'); ?></span>
                                                <small class="text-secondary" style="font-size: 0.75rem;">
                                                    <?php
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="text-center py-4 text-muted">
                                            <i
                                                class="fa-solid fa-folder-open fa-2x mb-2 text-warning opacity-75 d-block"></i>
                                            <span class="small">Belum ada catatan setoran hafalan terbaru dari anak asuh
                                                Anda.</span>
                                        </td>
                                    </tr>
                                <?php endif; ?>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="fw-bold text-dark-mode mb-0"
                            style="text-transform: none !important; font-size: 1rem;">
                            <i class="fa-solid fa-file-invoice-dollar text-warning me-2"></i> Tagihan & Pembayaran
                        </h5>
                        <a href="<?= base_url('wali/pembayaran'); ?>"
                            class="small text-warning text-decoration-none fw-semibold" style="font-size: 0.7rem;">
                            Lihat Semua <i class="fa-solid fa-arrow-right ms-1"></i></a>
                    </div>
                    <p class="text-secondary small mb-4" style="text-transform: none !important; font-size: 0.8rem;">
                        Status tagihan dan riwayat administrasi anak.</p>
                        ...
                        <?php foreach ($tagihan_terbaru as $row): ?>
                            ...
                            <div class="card p-3 bg-light rounded-4 mb-3">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <span class="badge bg-<?= $badgeColor; ?> bg-opacity-10 text-<?= $badgeColor; ?> px-2 py-1"
                                        style="font-size: 0.7rem;"><?= esc($status); ?></span>
                                    <small class="text-secondary"
                                        style="font-size: 0.75rem;"><?= date('d M Y', strtotime($row['tanggal'])); ?></small>
                                </div>
                                <h6 class="fw-semibold text-dark-mode mb-1" style="font-size: 0.9rem;">
                                    <?= esc($row['jenis_pembayaran']); ?> - <span
                                        class="text-primary"><?= esc($row['nama_santri']); ?></span>
                                </h6>
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    <span class="font-monospace fw-bold text-dark-mode" style="font-size: 0.85rem;">Rp
                                        ...
                                        <div class="modal-header bg-light px-4 py-3 border-bottom">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="rounded-circle bg-<?= $badgeColor; ?> bg-opacity-10 text-<?= $badgeColor; ?> d-flex align-items-center justify-content-center"
                                                    ...
                                                    <i
                                                        class="fa-solid <?= (strtolower($status) == 'pending') ? 'fa-wallet' : 'fa-file-invoice-dollar'; ?>"></i>
                                                </div>
                                                <div>
                                            ...
                                            <?php if (strtolower($status) == 'pending'): ?>
                                                <div class="mb-4">
                                                    <div class="small fw-bold text-dark mb-2"><i
                                                            class="fa-solid fa-wallet text-primary me-1"></i> Silakan Transfer ke
                                                        Rekening Resmi:</div>
                                                    <div class="row g-2">
                                                        <div class="col-12">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="font-monospace fw-bold text-dark fs-6">7123 4567 89
                                                                    </div>
                                                                    <div class="text-muted" style="font-size: 0.7rem;">a.n. Yayasan
                                                                        Hudfal</div>
                                                                </div>
                                                                <button type="button"
                                                        ...
                                                        <div class="col-12">
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="font-monospace fw-bold text-dark fs-6">1234 5678 90
                                                                    </div>
                                                                    <div class="text-muted" style="font-size: 0.7rem;">a.n. Yayasan
                                                                        Hudfal</div>
                                                                </div>
                                                ...
                                                <form action="<?= base_url('wali/riwayat-tagihan/konfirmasi/' . $row['id']); ?>"
                                                    ...
                                                    <div class="fw-semibold text-dark small mb-3">
                                                        <i class="fa-solid fa-cloud-arrow-up text-primary me-1"></i> Form Konfirmasi
                                                        Pembayaran:
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-medium text-muted">Ditransfer ke Rekening
                                                            Mana?</label>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="form-text text-muted" style="font-size: 0.7rem;">Format: JPG,
                                                            PNG, atau PDF. Maks 2MB.</div>
                                                    </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="text-center py-4 text-muted">
                            ...
                            <p class="small text-secondary mb-0">Belum ada data tagihan atau pembayaran saat ini.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
