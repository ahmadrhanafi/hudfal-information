<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-4 py-2 border-bottom sticky-top transition-base" id="mainNavbar">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <button class="btn btn-link text-dark p-0 d-lg-none" id="sidebarToggle" type="button">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-3 p-2 rounded-4 animate-fade-in" aria-labelledby="dropdownUser" style="min-width: 220px;">
                    ...
                    <li>
                        <button class="dropdown-item rounded-3 py-2 px-3 d-flex align-items-center gap-2 text-dark hover-bg-light transition-base w-100 border-0 bg-transparent" id="darkModeToggle" type="button">
                            <i class="fa-solid fa-moon text-warning" id="darkModeIcon"></i> <span class="small fw-medium">Ubah Tema</span>
                        </button>
                    </li>
                    <li>
