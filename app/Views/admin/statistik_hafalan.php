...
<div class="container-fluid px-0">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="<?= base_url('admin/statistik-hafalan/export?periode=' . $periode); ?>"
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                    <li><a class="dropdown-item small <?= ($periode == 'minggu_ini') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=minggu_ini'); ?>">Minggu Ini
                            (Harian)</a></li>
                    <li><a class="dropdown-item small <?= ($periode == 'minggu_lalu') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=minggu_lalu'); ?>">Minggu Lalu
                            (Harian)</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item small <?= ($periode == 'bulan_ini') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=bulan_ini'); ?>">Bulan Ini (Harian)</a>
                    </li>
                    <li><a class="dropdown-item small <?= ($periode == 'bulan_lalu') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=bulan_lalu'); ?>">Bulan Lalu
                            (Harian)</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item small <?= ($periode == 'tahun_ini') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=tahun_ini'); ?>">Tahun Ini (Bulanan)</a>
                    </li>
                    <li><a class="dropdown-item small <?= ($periode == 'tahun_lalu') ? 'active' : ''; ?>"
                            href="<?= base_url('admin/statistik-hafalan?periode=tahun_lalu'); ?>">Tahun Lalu
                            (Bulanan)</a></li>
                </ul>
            </div>
        </div>
                        ...
                        <?php foreach ($capaian_juz as $juz): ?>
                            <div class="mb-3">
                                <div class="d-flex justify-content-between small fw-semibold mb-1">
                                    ...
                                    <span
                                        class="text-<?= esc((string) ($juz['color'] ?? 'secondary')); ?>"><?= esc((string) ($juz['persen'] ?? 0)); ?>%</span>
                                </div>
                                <div class="progress" style="height: 8px;">
                                    <div class="progress-bar bg-<?= esc((string) ($juz['color'] ?? 'secondary')); ?> rounded-pill"
                                        role="progressbar" style="width: <?= esc((string) ($juz['persen'] ?? 0)); ?>%;"></div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
