        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 bg-white p-4 position-relative overflow-hidden">
                <div class="position-absolute top-0 end-0 mt-4 me-5 d-none d-lg-block">
                    <div class="rounded-circle bg-success bg-opacity-10 p-3 text-success d-flex align-items-center justify-content-center" style="width: 70px; height: 70px;">
                ...
                <div style="z-index: 1;">
                    ...
                    <h3 class="fw-bold text-dark-mode mb-1" style="text-transform: none !important;">Selamat Datang, <?= session()->get('name') ?>!</h3>
                    <p class="text-secondary small mb-0" style="text-transform: none !important;">Ringkasan data operasional sistem monitoring hafalan di Ponpes Hudatul Falah saat ini.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-4">
                    ...
                    <h6 class="text-secondary mb-1 font-monospace small" style="text-transform: none !important;">TOTAL SANTRI</h6>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h5 class="fw-bold text-dark-mode m-0" style="text-transform: none !important;">
                            <i class="fa-solid fa-chart-line text-success me-2"></i> Statistik Perkembangan Hafalan Semua Santri
                        </h5>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-light border dropdown-toggle px-3 rounded-pill" type="button" data-bs-toggle="dropdown">
                                Periode: <span class="fw-semibold"><?= ucwords(str_replace('_', ' ', $periode)); ?></span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                <li><a class="dropdown-item small <?= ($periode == 'minggu_ini') ? 'active' : ''; ?>" href="<?= base_url('admin/dashboard?periode=minggu_ini'); ?>">Minggu Ini</a></li>
                                <li><a class="dropdown-item small <?= ($periode == 'bulan_ini') ? 'active' : ''; ?>" href="<?= base_url('admin/dashboard?periode=bulan_ini'); ?>">Bulan Ini</a></li>
                                <li><a class="dropdown-item small <?= ($periode == 'tahun_ini') ? 'active' : ''; ?>" href="<?= base_url('admin/dashboard?periode=tahun_ini'); ?>">Tahun Ini</a></li>
                            </ul>
                        </div>
                    </div>
